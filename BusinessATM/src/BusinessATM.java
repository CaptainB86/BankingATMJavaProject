    ...
    public static void main(String[] args) {
        ...
        if (loggedIn) {
            ...
            while (true) {
                ...
                System.out.println("4. Transfer money ***to transfer money you must add two accounts first. They will be named account 1 and account 2***");
            ...
            switch (option) {
                ...
                case 1:
                    ...
                    switch (accountType) {
                        case 1:
                            account = new SmallBusinessAccount(accountName, Integer.toString(atm.accounts.size() + 1), accountType);
                            break;
                        case 2:
                            account = new CommunityAccount(accountName, Integer.toString(atm.accounts.size() + 1), accountType);
                            break;
                        case 3:
                            account = new ClientAccount(accountName, Integer.toString(atm.accounts.size() + 1), accountType);
                            break;
                        default:
                ...
                case 2:
                    ...
                    if (account1 == null || account2 == null) {
                        ...
                        if (transferSuccess) {
                            ...
                            System.out.println("New balance for account " + account1Number + ": " + atm.checkBalance(account1Number));
                            System.out.println("New balance for account " + account2Number + ": " + atm.checkBalance(account2Number));
